...
import br.com.sisbib.api.modelo.controller.form.AtualizaLivroForm;
...
public class LivroController {
	...
	@Transactional
	public ResponseEntity<LivroDto> atualizar(@PathVariable Long codBarras, @RequestBody @Valid AtualizaLivroForm form) {
