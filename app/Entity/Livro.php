...
class Livro extends Itens_Reserva{
     ...
     * @return array
     */
    public static function getLivros($where = null, $join = null, $and = null){
        return (new Database('livro'))->select($where,$join,$and)
                                        ->fetchAll(PDO::FETCH_CLASS,self::class);
    }

    /**
     * Metodo responsavel por obter os Livros no banco de dados para o usuario Aluno
     * @param string $where
     * @param string $join
     * @param string $and
     * @param string $like
     * @return array
     */
    public static function getLivros_2($where = null, $join = null, $and = null, $like = null){
